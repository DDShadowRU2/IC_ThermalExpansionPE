...
Block.createBlockWithRotation("pulverizer", [
    {
        name: "Pulverizer",
        texture: [["machine_bottom", 0], ["machine_top", 0], ["machine_side", 0], ["machine_face_pulverizer", 0], ["machine_side", 0], ["machine_side", 0]],
        inCreative: true
    }
]);
...
Callback.addCallback("PostLoaded", function () {
    Recipes.addShaped({id: BlockID.pulverizer, count: 1, data: 0}, [
        ...
        "b#b",
        "cac"
    ], ['#', BlockID.machineFrameBasic, 0, 'x', 33, 0, 'b', 318, 0, 'a', ItemID.RedstoneReceptionCoil, 0, 'c', ItemID.gearCopper]);
});
